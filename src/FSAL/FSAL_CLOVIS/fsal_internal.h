...
typedef struct clovis_file_handle {
	inogen_t clovis_handle;
	char i_snap;
} clovis_file_handle_t;
...
static inline size_t clovis_sizeof_handle(struct clovis_file_handle *hdl)
{
	return (size_t) sizeof(struct clovis_file_handle);
}
